  ...
  return (
    <section className="py-32 bg-background min-h-screen">
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        >
          <span className="text-white/40 uppercase tracking-[0.2em] text-xs font-medium mb-4 block">Weekend Appointments Only</span>
          <h1 className="text-4xl md:text-6xl font-serif text-white mb-6">Select Your Package</h1>
          ...
          {bookings.map((booking, index) => (
            ...
            >
              <Card className={`group border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-500 rounded-none overflow-hidden ${booking.highlight ? 'border-white/20 bg-white/[0.05]' : ''}`}>
                <div className="grid md:grid-cols-[1.5fr,1fr] gap-8 p-8 md:p-12">
                  <div className="flex flex-col justify-between h-full space-y-8">
                    <div>
                      <div className="flex items-center gap-3 text-white/40 text-xs uppercase tracking-widest mb-4">
                        <Clock size={14} />
                      ...
                      <h3 className="text-3xl font-serif text-white mb-4 group-hover:text-white/90 transition-colors">{booking.title}</h3>
                  ...
                  <div className="flex flex-col justify-between border-t md:border-t-0 md:border-l border-white/5 pt-8 md:pt-0 md:pl-12">
                    <div>
                      <span className="text-white/40 text-xs uppercase tracking-widest mb-6 block">Includes</span>
                    ...
                    <div className="space-y-4">
                      <div className="text-3xl font-light text-white">{booking.price}</div>
                      <Button 
