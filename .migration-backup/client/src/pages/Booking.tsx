          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center w-full max-w-md mb-8">
              <a href="tel:2703196059" className="w-full">
                <button className="w-full bg-primary text-black hover:bg-primary/90 rounded-none h-14 uppercase tracking-widest text-sm font-medium transition-colors">
                  Call (270) 319-6059
                </button>
              </a>
              <a href="sms:2703196059" className="w-full">
                <button className="w-full border border-primary/50 bg-transparent text-primary hover:bg-primary hover:text-black rounded-none h-14 uppercase tracking-widest text-sm font-medium transition-colors">
                  Text Us
                </button>
              </a>
            </div>
